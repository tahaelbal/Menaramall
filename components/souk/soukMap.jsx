...
export default function SoukMap() {
  return (
  <section
  ...
  onClick={() => {
    ...
    if (isMobile) {
      // Ouvre Waze sur mobile
      window.open(
        "https://waze.com/ul?q=Menara+Mall+Marrakech",
        "_blank"
      );
    } else {
      // Ouvre Google Maps sur ordinateur
      window.open(
...
>
  {/* Texte au-dessus de la carte */}
  <div className="max-w-7xl mx-auto px-4 py-4 relative z-10 bg-white/80 backdrop-blur-sm rounded-lg">
    ...
    <p className="text-center text-gray-700">
      ...
      Besoin d’itinéraire ? Cliquez sur la carte pour ouvrir Google Maps ou Waze et naviguer vers nous !
    </p>
  </div>
  ...
  {/* Message d’indication en bas à droite */}
  <div className="absolute bottom-3 right-3 bg-white/80 text-black text-sm px-3 py-1 rounded-lg shadow-lg">
